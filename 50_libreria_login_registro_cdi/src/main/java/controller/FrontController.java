	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		switch(operation) {
			...
			case "doLogin":
				...
				break;
			case "doRegistrar":
				request.getRequestDispatcher("AltaClienteController").forward(request, response);
				return;
			case "toRegistro": // peticion desde enlace registrese				 
				urlView="registro.html";
				break;
			case "toLogin": // peticion desde enlace registrese				 
				urlView="login.html";
				break;	
