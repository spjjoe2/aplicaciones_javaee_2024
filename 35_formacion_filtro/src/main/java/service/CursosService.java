...
public class CursosService{
	...
	public boolean nuevo(Curso curso) {		
		if(dao.findByNombre(curso.getNombre())==null) { //si es null, el curso no existe y se a̱ade
			dao.save(curso);
			return true;
		}
		return false;
	...
	public boolean eliminarCurso(String nombre) {
		if(dao.findByNombre(nombre)!=null) { //si es null, el curso no existe y se a̱ade
